            ...
            >
                <div className="max-w-md">
                    ...
                    >
                        <Link 
                            href="/"
                            className="inline-block px-8 py-4 text-lg font-semibold text-white bg-primary rounded-xl shadow-lg hover:bg-primary-dark transition-all duration-300 transform hover:-translate-y-1 focus:outline-none focus:ring-4 focus:ring-primary/30"
                        >
                            Go Back Home
                        </Link>
                    </motion.div>
