...
import { HelpCircle, RotateCcw, XCircle, Headphones, ChevronDown, Book, Search } from 'lucide-react';
        ...
        <div className="border-b border-gray-200">
            ...
            >
                ...
                <motion.div animate={{ rotate: isOpen ? 180 : 0 }} transition={{ duration: 0.3 }}>
                    <ChevronDown className={`text-gray-500 transition-colors ${isOpen ? 'text-blue-600' : ''}`} size={20} />
                </motion.div>
            </button>
        ...
        <AppLayout>
            ...
            >
                <div className="text-center mb-16">
                    <HelpCircle className="mx-auto text-5xl text-blue-600 mb-4" size={48} />
                    ...
                    <aside className="lg:col-span-1 lg:sticky top-24 self-start">
                        <div className="p-4 bg-gray-50 rounded-xl border border-gray-200/80">
                            ...
                            <ul className="space-y-3">
                                {[...contentSections, { id: 'faq', icon: <Book className="text-blue-500" size={20} />, title: 'FAQs' }].map(section => (
                                    <li key={section.id}>
                    ...
                    <main className="lg:col-span-3">
                        <div className="space-y-16">
                            ...
                            <section id="faq" className="scroll-mt-24">
                                <div className="flex items-center gap-4 mb-6">
                                    <div className="text-3xl text-blue-500"><Book size={32} /></div>
