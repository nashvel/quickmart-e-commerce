                        ...
                        <div className="space-y-8 lg:col-span-1">
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="ml-4">
                                    ...
                                    <a href="mailto:support@quickmart.com" className="mt-1 text-gray-600 hover:text-primary">
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="ml-4">
                                    ...
                                    <a href="tel:+1234567890" className="mt-1 text-gray-600 hover:text-primary">
                                        +1 (234) 567-890
                                    </a>
                                </div>
                            </div>
