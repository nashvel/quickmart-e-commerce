...
export default function ConvenienceStoresSection({ stores }: Props) {
        ...
        <section className="mb-16">
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold text-gray-800 flex items-center gap-3">
                    <StoreIcon className="text-primary" size={24} /> Shop by Store
                </h2>
                <Link href="/stores" className="text-primary font-medium hover:underline">
                    View All
                </Link>
            </div>
